    ...
    <div className="flex h-screen bg-slate-50 dark:bg-[#0f172a] transition-colors duration-300">
      ...
      >
        ...
        <div className="p-6 flex items-center gap-3 overflow-hidden whitespace-nowrap">
          ...
          <div className="min-w-[40px] h-10 bg-primary-600 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-primary-500/20">
            T
          </div>
        ...
        <div className="p-4 border-t border-slate-800">
          ...
          >
            ...
            <span className="min-w-[20px] group-hover:rotate-12 transition-transform">
              <LogOut size={20} />
            </span>
                    ...
                    >
                      ...
                      <div className="p-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center">
                        ...
                        {unreadCount > 0 && (
                          ...
                          <span className="text-[10px] bg-primary-100 text-primary-600 px-2 py-0.5 rounded-full font-bold uppercase">
                      ...
                      <div className="max-h-[300px] overflow-y-auto">
                        ...
                        {notifications.length === 0 ? (
                          ...
                          notifications.map((n) => (
                            ...
                            <div
                              key={n._id}
                              className="p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border-b border-slate-50 dark:border-slate-800 cursor-pointer"
                            >
